var cols=9,rows=16,game=function(){void 0,resetItemsProbas();var e=$("#game canvas")[0].getContext("2d"),n=function(){cols/rows<window.innerWidth/window.innerHeight?(e.canvas.height=window.innerHeight,e.canvas.width=e.canvas.height/rows*cols):(e.canvas.width=window.innerWidth,e.canvas.height=e.canvas.width/cols*rows)};n(),$(window).resize(function(e){e.target===window&&(n(),f())}),e.imageSmoothingEnabled=!1,e.mozImageSmoothingEnabled=!1,e.oImageSmoothingEnabled=!1,e.webkitImageSmoothingEnabled=!1;var t="straight";$(window).keydown(function(e){switch(e.which){case 37:t="left";break;case 38:t="straight";break;case 39:t="right"}});var a,o;$("#game canvas").on("touchstart",function(e){e.preventDefault(),a=e.originalEvent.targetTouches[0].pageX,o=setInterval(function(){i()},10)}),$(window).on("touchend",function(){evt.preventDefault(),clearInterval(o)}),$(window).on("touchmove",function(e){e.preventDefault(),a=e.originalEvent.targetTouches[0].pageX}),$("#game canvas").on("mousedown",function(e){e.preventDefault(),a=e.clientX,o=setInterval(function(){i()},10)}),$(window).on("mouseup",function(e){e.preventDefault(),clearInterval(o)}),$(window).on("mousemove",function(e){e.preventDefault(),a=e.clientX});var i=function(){var n;n=a<$("#game canvas").offset().left?1:a>$("#game canvas").offset().left+e.canvas.width?cols:Math.ceil((a-$("#game canvas").offset().left)/(e.canvas.width/cols)),t=n<l.position[0]?"left":n>l.position[0]?"right":"straight"},r=0,c=0,s=new Particles,l=new Snake,g=new Items,f=function(){e.clearRect(0,0,e.canvas.width,e.canvas.height),e.canvas.width=e.canvas.width,s.draw(e),l.draw(e),g.draw(e)};f();var d=setInterval(function(){f()},20),h=setInterval(function(){s.next()},20),v=setInterval(function(){r++,l.next(t),t="straight",g.next(),c=g.check(l,c),50===r&&(mineProbaAppear=.1),100===r&&($("body").animate({backgroundColor:"#4c6eff"}),mineProbaAppear=.15),150===r&&(mineProbaAppear=.2),200===r&&($("body").animate({backgroundColor:"#4c4cff"}),mineProbaAppear=.25),350===r&&($("body").animate({backgroundColor:"#4c7fff"}),resetItemsProbas()),400===r&&($("body").animate({backgroundColor:"#5858db"}),mineProbaAppear=.28),c+=l.getLength(),$("#score").html(c),l.getLength()<2&&w()},130),w=function(){function e(e,n){return n-e}if(clearInterval(d),clearInterval(v),clearInterval(h),$(window).unbind(),"undefined"!=typeof Storage){var n=localStorage.getItem("scores");n=n?JSON.parse(n):[],(n.length<5||c>n[n.length-1])&&(n.push(c),n.sort(e),6===n.length&&n.pop()),localStorage.setItem("scores",JSON.stringify(n))}updateScores(),$("body").animate({backgroundColor:"#ff4c4c"},function(){$("#lose").fadeIn(),lose()})}};
...
var maxNbApples=10,maxNbMines=100,appleProbaAppear,mineProbaAppear,resetItemsProbas=function(){appleProbaAppear=.5,mineProbaAppear=.05};resetItemsProbas();var Items=function(){this.apples=[],this.mines=[],this.checkApple=function(s){for(var e=0;e<this.apples.length;e++)if(this.apples[e].y===rows&&this.apples[e].x===s)return!0;return!1},this.next=function(){for(var s=0;s<this.apples.length;s++)this.apples[s].y--;for(var s=0;s<this.apples.length;s++)this.apples[s].y<0&&this.apples.splice(s,1);for(var s=0;s<this.mines.length;s++)this.mines[s].y--;for(var s=0;s<this.mines.length;s++)this.mines[s].y<0&&this.mines.splice(s,1);if(this.apples.length<maxNbApples&&Math.random()<appleProbaAppear){var e={x:Math.ceil(Math.random()*cols),y:rows};e.color=Math.random()>.5?"#ff4030":"#99db4c",this.apples.push(e)}if(this.mines.length<maxNbMines)for(var s=1;cols>=s;s++)if(!this.checkApple(s)&&Math.random()<mineProbaAppear){var i={x:s,y:rows};this.mines.push(i)}},this.draw=function(s){for(var e=s.canvas.width,i=s.canvas.height,t=e/cols,a=0;a<this.apples.length;a++)s.fillStyle=this.apples[a].color,s.fillRect((this.apples[a].x-1)*t+.1*t,i-this.apples[a].y*t+.2*t,.8*t,.6*t),s.fillRect((this.apples[a].x-1)*t+.2*t,i-this.apples[a].y*t+.1*t,.6*t,.8*t),s.fillStyle="#fff",s.fillRect((this.apples[a].x-1)*t+.7*t,i-this.apples[a].y*t+.2*t,.1*t,.1*t);for(var a=0;a<this.mines.length;a++)s.fillStyle="#6b00c7",s.fillRect((this.mines[a].x-1)*t+.1*t,i-this.mines[a].y*t+.2*t,.8*t,.6*t),s.fillRect((this.mines[a].x-1)*t+.2*t,i-this.mines[a].y*t+.1*t,.6*t,.8*t)},this.check=function(s,e){for(var i=s.position[0],t=0;t<this.apples.length;t++)this.apples[t].y!==maxSnakeLength&&this.apples[t].y!==maxSnakeLength-1||this.apples[t].x!==i||(s.eat(),this.apples.splice(t,1),e+=50);for(var t=0;t<this.mines.length;t++)this.mines[t].y!==maxSnakeLength&&this.mines[t].y!==maxSnakeLength-1||this.mines[t].x!==i||(s.hit(),this.mines.splice(t,1));return e}};
var lose=function(){void 0,$("#lose div.buttons button:first").click(function(){blinkEffect(this),playSoundGood(),$("#lose div.buttons button").unbind(),$("#lose").fadeOut(function(){gameToIntro()})}),$("#lose div.buttons button:nth-child(2)").click(function(){blinkEffect(this),playSoundGood(),$("#lose div.buttons button").unbind(),$("#lose").fadeOut(function(){$("body").animate({backgroundColor:"#4c7fff"},function(){game()})})}),$("#lose div.buttons button:last").click(function(){blinkEffect(this),playSoundGood(),$("#lose div.buttons button").unbind(),$("#lose").fadeOut(function(){gameToScore()})}),$(window).keydown(function(o){switch(o.which){case 37:$("#lose div.buttons button:first").click();break;case 38:case 40:$("#lose div.buttons button:nth-child(2)").click();break;case 39:$("#lose div.buttons button:last").click()}})};
$(document).ready(function(){FastClick.attach(document.body),$("#game").hide(),$("#lose").hide(),$("#scores").hide(),updateScores(),intro()});var introToGame=function(){$("#intro").fadeOut(function(){$("body").animate({backgroundColor:"#4c7fff"}),$("#game").fadeIn(function(){game()})})},introToScores=function(){$("#intro").fadeOut(function(){$("body").animate({backgroundColor:"#ff754c"}),$("#scores").fadeIn(function(){scores()})})},scoresToIntro=function(){$("#scores").fadeOut(function(){$("body").animate({backgroundColor:"#84c455"}),$("#intro").fadeIn(function(){intro()})})},gameToIntro=function(){$("#game").fadeOut(function(){$("body").animate({backgroundColor:"#84c455"}),$("#intro").fadeIn(function(){intro()})})},gameToScore=function(){$("#game").fadeOut(function(){$("body").animate({backgroundColor:"#ff754c"}),$("#scores").fadeIn(function(){scores()})})},blinkEffect=function(o){$(o).addClass("hover"),setTimeout(function(){$(o).removeClass("hover")},100)};
...
var soundOn=!0,soundGood=new Howl({urls:["sound/good.mp3"]}),soundBad=new Howl({urls:["sound/bad.mp3"]}),playSoundGood=function(){soundOn&&soundGood.play()},playSoundBad=function(){soundOn&&soundBad.play()};$("#sound button").click(function(){soundOn=!soundOn,blinkEffectSound(this)});var blinkEffectSound=function(o){var n=$("#sound button img")[0];n.src=soundOn?"img/sound_on_hover.gif":"img/sound_off_hover.gif",$(o).addClass("hover"),setTimeout(function(){$(o).removeClass("hover"),n.src=soundOn?"img/sound_on.gif":"img/sound_off.gif"},100)};